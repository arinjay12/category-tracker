...
> **Heads up:** this is the first Claude Code skill I've shipped and the first thing I've open-sourced by myself. Expect rough edges. If something breaks, [file an issue](https://github.com/sanketn/india-d2c/issues).
...
git clone https://github.com/sanketn/india-d2c ~/.claude/skills/india-d2c
```
...
Built by [Sanket Nadhani](https://x.com/sanketnadhani). DM me if you ship something from this.

Adapted from a personal daily-email D2C idea-finding tool into a chat-native, single-user-installable Claude Code skill.
