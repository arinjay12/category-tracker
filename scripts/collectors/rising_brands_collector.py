...
CATEGORY_QUERY_POOLS: dict[str, list[tuple[str, str, str]]] = {
    ...
    "cognitive_wellness": [
        ("new nootropic brain supplement DTC brand launch", "site:modernretail.co", "Modern Retail"),
        ("emerging cognitive health supplement venture funding", "site:retailbrew.com", "Retail Brew"),
        ("rising lion's mane bacopa nootropic category", "site:explodingtopics.com", "Exploding Topics"),
        ("indie focus memory supplement brand to watch", "site:retailbrew.com", "Retail Brew"),
        ("new brain health D2C brand launch 2026", "site:modernretail.co", "Modern Retail"),
        ("trending nootropic cognitive supplement brand", "site:thefascination.com", "The Fascination"),
    ],
    "spiritual_lifestyle": [
        ("new meditation wellness lifestyle brand launch", "site:modernretail.co", "Modern Retail"),
        ("emerging mindfulness ritual product brand funding", "site:retailbrew.com", "Retail Brew"),
        ("rising incense aromatherapy spiritual product category", "site:explodingtopics.com", "Exploding Topics"),
        ("indie yoga meditation accessory brand to watch", "site:retailbrew.com", "Retail Brew"),
        ("new premium incense ritual self-care D2C brand", "site:modernretail.co", "Modern Retail"),
        ("trending spiritual wellness lifestyle brand 2026", "site:thefascination.com", "The Fascination"),
    ],
    "sleep_recovery": [
        ("new sleep supplement DTC brand launch 2026", "site:modernretail.co", "Modern Retail"),
        ("emerging sleep recovery brand venture funding", "site:retailbrew.com", "Retail Brew"),
        ("rising magnesium glycine sleep supplement category", "site:explodingtopics.com", "Exploding Topics"),
        ("indie sleep hygiene recovery brand to watch", "site:retailbrew.com", "Retail Brew"),
